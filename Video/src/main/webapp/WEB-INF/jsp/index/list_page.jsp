...
<!--图片-->
<div style=" background:url(images/bg_b1.png) center repeat; height:221px;"></div>
</div>
<!---->
...
<div class="movielist" id="movie_list">
  <ul class="clearfix">
    ...
    <a href="select.html" class="movie_img">
     <img src="video/d1.jpg"  width="183px;"/>
     <span class="v_title">
    ...
    <div class="movie_title">
     ...
     <li class="movie_theme">
     <i class="icon_b yg_ico"></i>
    <a href="select.html" class="movie_img">
     <img src="video/d1.jpg"  width="183px;"/>
     <span class="v_title">
      <em></em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
      <p class="movie_name"><a href="#" class="name">人民的名义</a><span class="status">预告</span></p>
      <p class="Description">揭秘最深政治生态</p>
     </div>
    </li>
     <li class="movie_theme">
    ...
    <a href="#" class="movie_img">
     <img src="video/d5.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <li class="movie_theme">
     <i class="icon_b tj_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d2.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
      <p class="movie_name"><a href="#" class="name">人民的名义</a><span class="status">特辑</span></p>
      <p class="Description">揭秘最深政治生态</p>
     </div>
    </li>
     <li class="movie_theme">
     <i class="icon_b vip_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d3.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
      <p class="movie_name"><a href="#" class="name">人民的名义</a><span class="status">VIP</span></p>
      <p class="Description">揭秘最深政治生态</p>
     </div>
    </li>
     <li class="movie_theme">
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d4.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    ...
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d9.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d8.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d7.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
    <div class="movie_title">
     ...
     <i class="icon_b rb_ico"></i>
    <a href="#" class="movie_img">
     <img src="video/d6.jpg"  width="183px;"/>
     <span class="v_title">
      <em>更新至24集</em><i class="fraction">4.5分</i>
     </span>
    </a>
